...
exports.ReadBatch = class RocksDBReadBatch extends RocksDBBatch {
  ...
  async _flush() {
    ...
    this._db._state.stats.gets += this.stats.gets
    this._db._state.stats.readBatchesFlushed++
  }
...
exports.WriteBatch = class RocksDBWriteBatch extends RocksDBBatch {
  ...
  async _flush() {
    ...
    this._db._state.stats.puts += this.stats.puts
    this._db._state.stats.writeBatchesFlushed++
