...
static const std::string rocksdb_build_git_sha  = "rocksdb_build_git_sha:3f7c92b9753b697ce6a5ea737086d2751f17956c";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:";
#define HAS_GIT_CHANGES 0
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-06-14 22:32:14";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2023-09-07 11:54:32";
#endif
